                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul id="portfolio-flters">
                            <li data-filter="*" class="filter-active">所有類型</li>
                            @foreach ($category as $c)
                            <li data-filter=.filter-{{ $c->id }}>{{ trans($c->name) }}</li>
                            @endforeach
                        </ul>
                    </div>
                </div>
                <div class="row portfolio-container" id="portfolio-container" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="500">
                    @foreach ($news as $n)
